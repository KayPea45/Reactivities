...
export default function ActivityDetailsSidebar({ activity }: Props) {
	const following = true; // Placeholder for now, we will implement this later
	return (
		<>
			<Paper
				sx={{
								...
								<ListItem>
									<ListItemAvatar>
										<Avatar
											...
											src={attendee.imageUrl} // dont need to use ternary as if imageUrl is null, it will use default image from Avatar
