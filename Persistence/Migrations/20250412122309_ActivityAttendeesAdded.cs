            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade); // ReferentialAction.Cascade means that if the activity is deleted, all the attendees will be deleted as well vice versa for the User side as well
                    table.ForeignKey(
